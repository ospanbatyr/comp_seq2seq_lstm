...
# DO USE TOKEN BELOW
python -u -m src.main -mode test -project_name test_runs -pretrained_model_name scan_comp_train1 -finetune_data_voc none -no-dev_set -no-test_set -gen_set -dataset scan/compositional/train_2 -beam_decode -batch_size 4096 -run_name scan_comp_train2_model_negs -gpu 0 -topk 250
# todo change epoch
