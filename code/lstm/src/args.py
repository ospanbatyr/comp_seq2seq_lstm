...
def build_parser():
	...
	# Beam search option
	parser.add_argument('-beam_decode', dest='beam_decode', action='store_true', help='To generate model negatives, perform beam decoding')
	...
	# ADDED! - As we do not have any validation set to test on, we will choose the best train accuracy option.
	parser.add_argument('-model_selector_set', type=str, default='gen', choices=['val', 'test', 'gen', 'train'], help='Dataset whose evaluation performance to use for model selection')
